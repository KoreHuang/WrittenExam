 ...
 * 运算符未处理组合运算 ++、--、+= 等
 */
public class LexerWordParse extends KeyWords{
	...
	public LexerWordParse() {
	}
	/**
	 * 读取指定路径文件
	 * @param fileSrc 读取文件路径
	 */
	public LexerWordParse(String fileSrc) {
		FileOperations.readFile(buffer, fileSrc);
	}
	...
	public static void main(String[] args) {
		LexerWordParse lexer = new LexerWordParse("./src/input.txt");
		lexer.analyse();
	}
	/**
